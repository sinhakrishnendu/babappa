#pyinstaller --onefile --noconsole --icon=butterfly_icon.ico babappa_gui.py
...
class BabappaGUI(QWidget):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("BABAPPA GUI")
        self.setWindowIcon(QIcon("butterfly_icon.ico"))
