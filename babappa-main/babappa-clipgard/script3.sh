...
species_files=$(find "$msa_dir" -maxdepth 1 -name "*_msa.best.fas*.fas" -printf "%f\n")

for msa_file in $species_files; do
    # Extract the species name for the folder
    species=$(basename "$msa_file" .fas)
